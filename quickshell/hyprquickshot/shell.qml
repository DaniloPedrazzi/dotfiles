// Credits to https://github.com/JamDon2/hyprquickshot
...
FreezeScreen {
    ...
    function processScreenshot(x, y, width, height) {
        ...
        const picturesDir = Quickshell.env("HQS_DIR") || Quickshell.env("XDG_SCREENSHOTS_DIR") || Quickshell.env("XDG_PICTURES_DIR") || (Quickshell.env("HOME") + "/Pictures/Screenshots")
