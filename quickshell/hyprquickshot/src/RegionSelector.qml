...
Item {  
    ...
    Behavior on selectionX { SmoothedAnimation { duration: 60 }  }
    Behavior on selectionY { SmoothedAnimation { duration: 60 }  }
    Behavior on selectionHeight { SmoothedAnimation { duration: 60 }  }
    Behavior on selectionWidth { SmoothedAnimation { duration: 60 }  }
